...
export default class BinarySearchTree extends BinaryTree {
  public static size(node: BinaryTreeNode | null): number {
    return BinarySearchTree.height(node)
  };
  public levelOrder: (callback?: (node: BinaryTreeNode) => void) => number[]
  public insert: () => void;
  public remove: () => void;
  public findMin:() => BinaryTreeNode;
  public findMax: () => BinaryTreeNode;
  public findNode: (value: number) => BinaryTreeNode;
